...
plt.savefig(f"Results/Ridge/RidgeReg_degree{maxdegree}_train_error.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/Ridge/RidgeReg_degree{maxdegree}_test_error.png", dpi=150)
plt.show()
