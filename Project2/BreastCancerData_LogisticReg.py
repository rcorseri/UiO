...
for lmbd in lambdas:
    ...
    for eta in etas: 
        ...
        dnn2 = LogisticRegression(solver='lbfgs',C = 1/lmbd)
...
plt.savefig(f"Results/Logistic/BreastCancer_Logistic_regression_train.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/Logistic/BreastCancer_Logistic_regression_test.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/Logistic/BreastCancer_Logistic_regression_train_scikit.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/Logistic/BreastCancer_Logistic_regression_test_scikit.png", dpi=150)
plt.show()
