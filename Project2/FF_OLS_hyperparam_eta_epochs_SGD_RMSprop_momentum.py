...
plt.savefig(f"Results/OLS/RMSprop/OLS_hyper_epochs_RMSprop_train_error.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/OLS/RMSprop/OLS_hyper_epochs_RMSprop_test_error.png", dpi=150)
plt.show()
