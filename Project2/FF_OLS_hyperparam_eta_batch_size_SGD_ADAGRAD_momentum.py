...
plt.savefig(f"Results/OLS/ADAGRAD/OLS_hyper_batch_size_ADAGRAD_train_error.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/OLS/ADAGRAD/OLS_hyper_batch_size_ADAGRAD_test_error.png", dpi=150)
plt.show()
