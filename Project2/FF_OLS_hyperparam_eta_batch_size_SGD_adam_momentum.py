...
plt.savefig(f"Results/OLS/ADAM/OLS__hyper_batchsize_ADAM_train_error.png", dpi=150)
plt.show()
...
plt.savefig(f"Results/OLS/ADAM/OLS_hyper_batchsize_ADAM_test_error.png", dpi=150)
plt.show()
