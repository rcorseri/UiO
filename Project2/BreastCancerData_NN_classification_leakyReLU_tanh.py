...
heat1.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score training set (Act:leakyReLU-tanh)")
plt.savefig(f"Results/NN/BreastCancer_tanh_accuracy_score_train.png", dpi=150)
plt.show()
...
heat2.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score test set (Act:leakyReLU-tanh)")
plt.savefig(f"Results/NN/BreastCancer_tanh_accuracy_score_test.png", dpi=150)
plt.show()
