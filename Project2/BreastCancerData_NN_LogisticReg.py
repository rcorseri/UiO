...
from NeuralNetwork_LogisticReg import NeuralNetwork, sigmoid
...
heat1.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score training set ")
plt.savefig(f"Results/NN/BreastCancer_Logistic_regression_train.png", dpi=150)
plt.show()
...
heat2.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score test set ")
plt.savefig(f"Results/NN/BreastCancer_Logistic_regression_test.png", dpi=150)
plt.show()
...
heat3.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score training set Scikit")
plt.savefig(f"Results/NN/BreastCancer_Logistic_regression_train_scikit.png", dpi=150)
plt.show()
...
heat4.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score test set Scikit")
plt.savefig(f"Results/NN/BreastCancer_Logistic_regression_test_scikit.png", dpi=150)
plt.show()

# Logistic Regression Scikit
logreg = LogisticRegression(solver='lbfgs')
logreg.fit(x_train, z_train)
print("Test set accuracy with Logistic Regression (Scikit): {:.2f}".format(logreg.score(x_test,z_test)))
